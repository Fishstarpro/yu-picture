package com.yxc.yupicturebackend.manager.auth;
...
import com.yxc.yupicturebackend.manager.auth.SpaceUserAuthContext;
...
import static com.yxc.yupicturebackend.constant.UserConstant.USER_LOGIN_STATE;
...
public class StpInterfaceImpl implements StpInterface {
    ...
    private SpaceUserAuthContext getAuthContextByRequest() {
        ...
        if (ContentType.JSON.getValue().equals(contentType)) {
            ...
            authRequest = JSONUtil.toBean(jsonBody, SpaceUserAuthContext.class);
        } else {
